// BuiltInPresets.swift — Psychedelic and demo presets embedded directly in the binary.
// These always appear in the preset list regardless of Xcode bundle resource setup.
