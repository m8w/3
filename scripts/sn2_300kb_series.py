#!/usr/bin/env python3
"""
sn2_300kb_series.py — sn2_chaos8_runs.py, plus real melodic material pulled
from 13 found MIDI files (all ~300KB, hence the name) instead of purely
algorithmic runs.

FOUND-FLOOR PHRASES: found_floor_phrases.json (built once from z 2.mid, two
reals 1.mid, third atomsphere twelve.mid, parts of Being as it is 2_1x_1.mid,
New Presets 3 reaper xray 1/2.mid, mind of one 1.mid, midi madness sorta
1.MID, korg-supernova II midi mixing 5.mid, galaxies edges 3x.mid, evil
secrets of timelessness 1.mid, begin sequence series Mns.mid, and afterends
1.mid) holds ~9,100 short melodic phrases as relative-semitone patterns, 700
drawn evenly from each source file. Both the SN2's wandering run and a new
...
Run:      python3 sn2_300kb_series.py
"""
import rtmidi
import time
import math
...
def main():
    ...
    print(f"\n300kb series -- {NUM_CHANNELS} SN2 channels of random notes + mod wheel, "
